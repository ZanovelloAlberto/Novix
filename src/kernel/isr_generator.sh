...
echo "#include <arch/i686/idt.h>" >> $ISRS_GEN_C
echo "" >> $ISRS_GEN_C
...
for i in $(seq 0 255); do
    echo "    i686_IDT_setGate(${i}, i686_ISR${i}, IDT_ATTRIBUTE_32BIT_INTERRUPT_GATE | IDT_ATTRIBUTE_DPL_RING0 | IDT_ATTRIBUTE_PRESENT_BIT);" >> $ISRS_GEN_C
done
