...
//     try expectEqual(@intFromPtr(physToVirt(@ptrFromInt(*align(1) usize, 123))), offset + 123);
// }
...
//     try expectEqual(@intFromPtr(virtToPhys(@ptrFromInt(*align(1) usize, offset + 123))), 123);
// }
